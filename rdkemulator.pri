...
contains(DEFINES, USE_DISPLAY_SETTINGS) {
       ...
       SOURCES += $$(RDK_PROJECT_ROOT_PATH)/servicemanager/src/services/displaysettingsservice.cpp
       HEADERS += $$(RDK_PROJECT_ROOT_PATH)/servicemanager/include/services/displaysettingsservice.h
